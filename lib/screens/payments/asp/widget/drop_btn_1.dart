...
class AspDropDownButton1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final cubit = context.read<DropButtonCubit>();
    return Column(
      children: [
        Divider(),
        SizedBox(height: 20),
        Container(
          ...
          child: BlocBuilder<DropButtonCubit, DropButtonState>(
            builder: (context, state) {
              return DropdownButtonFormField(
                ...
                onChanged: (String? value) {
                  context.read<DropButtonCubit>().onChangedProgramName(value!);
                },
              ...
              child: BlocBuilder<DropButtonCubit, DropButtonState>(
                builder: (context, state) {
                  return DropdownButtonFormField(
                    ...
                    items: state.sessions
                        .map(
                          (session) => DropdownMenuItem(
                            ...
                            onTap: () {
                              context.read<DropButtonCubit>().setAspPrice(
                                    price: session.price!,
                                  );
                            },
                          ),
                    ...
                    value: context.read<DropButtonCubit>().sessionValue,
                  );
                },
              ),
            ),
          ...
          children: [
            ...
            Container(
              ...
              child: Center(
                child: Builder(
                  builder: (context) {
                    final state = context.watch<DropButtonCubit>().state;
